...
class DownloadSLSsteamTask(QObject):
            ...
            try:
                ...
                if self._steam_path:
                    ...
                    if install_type == "flatpak":
                        self.progress.emit(
                            "Copying SLSsteam libraries to Flatpak path..."
                        )
    ...
    @staticmethod
    def _find_7z_download_url(release_data):
    ...
    @staticmethod
    def _find_setup_script(base_dir):
    ...
    @staticmethod
    def _save_version_info(slssteam_dir, version):
    ...
    @staticmethod
    def _get_steam_install_type(steam_path):
    ...
    @staticmethod
    def _copy_so_to_flatpak(slssteam_dir):
    ...
    @staticmethod
    def _patch_steam_sh(steam_path, install_type):
        ...
        try:
            ...
            new_lines = [line for line in lines if "export LD_AUDIT=" not in line]
    ...
    @staticmethod
    def _create_steam_cfg(steam_path):
